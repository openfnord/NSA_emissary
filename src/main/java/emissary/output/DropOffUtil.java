...
public class DropOffUtil {
    ...
    protected void configure(final Configurator configG) {
        ...
        if (actualConfigG != null) {
            ...
            this.dateParser = actualConfigG.findStringEntry("DATE_PARSING_CLASS", "LEGACY");
    ...
    /**
     * Getter for dateParser
     * 
     * @return the date parser to use
     */
    public String getDateParser() {
