...
public class DateTimeFormatParserTest extends UnitTest {
    ...
    private void test(String date, long expected, String msg) {
        ...
        Assertions.assertEquals(expected, unknownParse == null ? 0L : unknownParse.toEpochSecond(ZoneOffset.UTC), "Error on: " + msg);
    }
    ...
    /*
     * @Test void testCleanDateString() { test("2016-01-04 18:20<br>", EXPECTED_NO_SECS, "HTML");
     * test("2016-01-04\t\t18:20", EXPECTED_NO_SECS, "TABS"); test("2016-01-04        18:20", EXPECTED_NO_SECS, "SPACES");
